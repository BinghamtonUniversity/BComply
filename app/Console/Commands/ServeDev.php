...
class ServeDev extends Command
{
     ...
     * @var string
     */
    protected $description = 'Serve BComploy Locally from bcomplydev.local:8000';
    ...
    {
        return [
            ['host', null, InputOption::VALUE_OPTIONAL, 'The host address to serve the application on', 'bcomplydev.local'],
