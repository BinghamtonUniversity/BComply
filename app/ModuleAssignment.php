...
{
    protected $fillable = ['user_id','module_version_id','module_id','date_assigned','date_due','updated_by_user_id','assigned_by_user_id','current_state','date_completed','date_started','score','duration'];
