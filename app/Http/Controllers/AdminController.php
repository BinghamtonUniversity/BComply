...
class AdminController extends Controller
{
    ...
    public function admin(Request $request,Module $module) {
        return view('default.admin',['page'=>null,'id'=>null,'title'=>'Admin','module'=>$module]);
    }
    public function users(Request $request,Module $module) {
        return view('default.admin',['page'=>'users','id'=>null,'title'=>'Manage Users','module'=>$module,'help'=>
    ...
    public function user_assignments(Request $request, User $user,Module $module) {
        return view('default.admin',['page'=>'users_assignments','id'=>$user->id,'module'=>$module,'title'=>$user->first_name.' '.$user->last_name.' Module Assignments','help'=>
    ...
    public function groups(Request $request,Module $module) {
        return view('default.admin',['page'=>'groups','id'=>null,'title'=>'Manage Groups','module'=>$module,'help'=>
    ...
    public function group_members(Request $request, Group $group,Module $module) {
        return view('default.admin',['page'=>'groups_members','id'=>$group->id,'module'=>$module,'title'=>$group->name.' Memberships','help'=>
