ajax.get('/api/workshop_reports',function(data) {
    gdg = new GrapheneDataGrid({el:'#adminDataGrid',
    item_template: gform.stencils['table_row'],
    search: false,columns: false,upload:false,download:false,title:'Workshop Reports',
    entries:[],
    actions:actions,
    count:20,
    schema:[
        ...
        ajax.post('/api/workshop_reports',grid_event.model.attributes,function(data) {
        ...
        ajax.put('/api/workshop_reports/'+grid_event.model.attributes.id,grid_event.model.attributes,function(data) {
        ...
        ajax.delete('/api/workshop_reports/'+grid_event.model.attributes.id,{},function(data) {},function(data) {
            grid_event.model.undo();
        });
