ajax.get('/api/workshops/'+id+'/offerings',function(data) {
    ...
    schema:[
        ...
        {type:"user", name:"instructor_id",required:true, label:"Instructor", template:"{{attributes.user.first_name}} {{attributes.user.last_name}}"},
        ...
        ajax.post('/api/workshop/'+grid_event.model.attributes.id+'/offerings/'+id,grid_event.model.attributes,function(data) {
           // debugger;
