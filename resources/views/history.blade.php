                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-header">
                                                @if(($assignment->status==='incomplete'))
                                                    <div class="pull-right" style="padding: 0 5px;background-color:#d9534f;color:white;">Incomplete</div>
                                                @else
                                            ...
                                            <div class="panel-footer">
                                                @if(($assignment->status==='completed')||($assignment->status==='passed')||($assignment->status==='attended'))
                                                    ...
                                                    <div id="certificate"><a href="/assignment/{{$assignment->id}}/certificate"><i class="fa fa-download"></i> Download Certificate</a></div>
                                                @else
                                                    <div class="badge" style="background-color:#d9534f">Incomplete</div>
                                                    <div id="certificate">No Certificate Available</div>
                                                @endif
                                            </div>
                                        </div>
                                    </a>
